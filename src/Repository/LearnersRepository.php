...
/**
 * @extends ServiceEntityRepository<Learners>
 *
 ...
 */
class LearnersRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(Learners $entity, bool $flush = false): void
    {
    ...
    public function remove(Learners $entity, bool $flush = false): void
    {
